...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Data.DmCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebApp.Data.DmStuCour", b =>
                {
            ...
            modelBuilder.Entity("WebApp.Data.DmStudent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebApp.Data.DmStuCour", b =>
                {
                    b.HasOne("WebApp.Data.DmCourse", "Course")
                        .WithMany("Students")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebApp.Data.DmStudent", "Student")
                        .WithMany("Courses")
