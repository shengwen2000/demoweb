...
define(["require", "exports", "../webapp/common", "../webapp/master2", "../webapp.sys/sys010"], function (require, exports, common_1, master2_1, sys010_1) {
     ...
     * 旺北系統日誌檔
     */
    var NORTH003Ctrl = /** @class */ (function (_super) {
        __extends(NORTH003Ctrl, _super);
        function NORTH003Ctrl($http, Config, $q, $scope) {
        ...
        NORTH003Ctrl.prototype.onQuery = function () {
            return this.$http.get(this.Config.AppPath + "/log_list");
        };
        NORTH003Ctrl.prototype.onRecordView = function (record) {
            return this.$http.get(this.Config.AppPath + "/log_get/" + record.Name);
        };
        NORTH003Ctrl.prototype.reload = function (record) {
    ...
    function startApp(sitepath, apppath) {
        ...
        angular.module("app")
            ...
            .controller('MainCtrl', NORTH003Ctrl)
            .run(function () {
        });
...
//# sourceMappingURL=north003.js.map